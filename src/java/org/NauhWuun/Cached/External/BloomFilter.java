...
public class BloomFilter implements Cloneable 
{
    ...
    /**
     * If the element is in the container, returns true. If the element is not in
     * the container, returns true with a probability ≈ e^(-ln(2)² * m/n), otherwise
     * false. So, when m is large enough, the return value can be interpreted as: -
     * true : the element is probably in the container - false : the element is
     * definitely not in the container
     **/
     ...
     **/
    public int hashCode() {
        return (int) HashAlgorithm.FNV1A_64_HASH(String.valueOf(k));
    }
